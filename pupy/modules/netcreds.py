...
class NetCreds(PupyModule):
    ...
    def init_argparse(cls):
        ...
        find.add_argument(username, help='Username')
        remove.add_argument('-P', '--password', help='Password')
        ...
        find = commands.add_parser('find', help='Find credentials which can be found using these flags')
        find.add_argument(username, help='Username')
        find.add_argument('-P', '--password', help='Password')
    ...
    def list(self, args):
        export = self.client.remote('network.lib.netcreds', 'export')
        creds = export()
